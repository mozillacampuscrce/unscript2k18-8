package com.codeblooded.chehra.teacher.data;
...
public class AttendanceDbHelper extends SQLiteOpenHelper {
    ...
    public void putDepartments(com.codeblooded.chehra.teacher.models.BiMap<Integer, String> map) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public com.codeblooded.chehra.teacher.models.BiMap<Integer, String> getDepartments(boolean inverseMap) {
        com.codeblooded.chehra.teacher.models.BiMap<Integer, String> map = new com.codeblooded.chehra.teacher.models.BiMap<>();
        String[] projection = {
